ServerEvents.recipes((event) => {
  function addCokeRecipe(input, output, creosote_amount, ticks) {
    event.recipes.custommachinery
      .custom_machine("ftb:advanced_coke_oven", ticks)
  ...
  const coke_oven_recipes = [
    { input: "#minecraft:logs_that_burn", output: "minecraft:charcoal", creosote_amount: 250, ticks: 800 },
    { input: "minecraft:coal", output: "ftbmaterials:coal_coke_gem", creosote_amount: 500, ticks: 800 },
    { input: "minecraft:coal_block", output: "ftbmaterials:coal_coke_block", creosote_amount: 5000, ticks: 14400 }
  ]
